	...
	<div class="row align-items-md-stretch">
		...
		<form name="newBook" action="./processAddBook.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-3">
					<textarea rows="2" cols="50" name="description" id="description" class="form-control" placeholder="100자 이상 적어주세요"></textarea>
				</div>
			</div>
			<div class="mb-3 row">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-3">
					<input type="text" id="unitsInStock" name="publisher" class="form-control">
				</div>
			</div>
			<div class="mb-3 row">
